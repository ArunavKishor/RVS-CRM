...
const callStatuses = ["Form Issued", "Dead Leads", "Nurturing"];

const autoStatusByTag = {
  "Form shared": "Form Issued",
  "Need more nurturing": "Nurturing",
  "Not interested": "Dead Leads",
  "Already joined": "Dead Leads",
  "Call not connected": "Nurturing",
};
...
const mockCallLogs = [
  {
    ...
    status: "Form Issued",
    tag: "Form shared",
    duration: "10 mins 05 secs",
    remarks:
      "Parent asked for admission form and fee breakup. Shared details on WhatsApp.",
    templateSent: "Admission Form Link",
  },
];

export function VisitCCallaActionModal({
  onClose,
  lead,
  onSubmit,
  sectionName,
